...
public class VideoGameApp {
	...
	HashMap enemies = new HashMap<Integer, Long>();
	...
	private void displayElements() {
		...
		Iterator itr = this.enemies.keySet().iterator();
		while (itr.hasNext()) {
			Integer key = (Integer) itr.next();
			System.out.println("The enemy with an id " + key + " has " + this.enemies.get(key) + " experience points.");
		}
	}
}
